...
export declare type ToggleGroupControlOptionIconProps = Omit<ToggleGroupControlOptionBaseProps, 'children'> & {
    /**
...
export declare type ToggleGroupControlOptionProps = Omit<ToggleGroupControlOptionBaseProps, 'children'> & {
    /**
