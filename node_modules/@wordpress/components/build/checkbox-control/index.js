...
function CheckboxControl(_ref) {
  ...
  const [showIndeterminateIcon, setShowIndeterminateIcon] = (0, _element.useState)(false); // Run the following callback everytime the `ref` (and the additional
  // dependencies) change.
  ...
  }, props)), showIndeterminateIcon ? (0, _element.createElement)(_icons.Icon, {
    icon: _icons.reset,
