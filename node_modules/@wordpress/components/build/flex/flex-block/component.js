...
function FlexBlock(props, forwardedRef) {
  ...
  return (0, _element.createElement)(_view.View, (0, _extends2.default)({}, flexBlockProps, {
    ref: forwardedRef
  }));
}
/**
...
const ConnectedFlexBlock = (0, _context.contextConnect)(FlexBlock, 'FlexBlock');
var _default = ConnectedFlexBlock;
