...
export default compose([withSelect((select, _ref3) => {
  ...
  const colorsPalettes = settings === null || settings === void 0 ? void 0 : (_settings$__experimen = settings.__experimentalFeatures) === null || _settings$__experimen === void 0 ? void 0 : (_settings$__experimen2 = _settings$__experimen.color) === null || _settings$__experimen2 === void 0 ? void 0 : _settings$__experimen2.palette;
  const allColorsPalette = [...((colorsPalettes === null || colorsPalettes === void 0 ? void 0 : colorsPalettes.theme) || []), ...((colorsPalettes === null || colorsPalettes === void 0 ? void 0 : colorsPalettes.custom) || []), ...((colorsPalettes === null || colorsPalettes === void 0 ? void 0 : colorsPalettes.default) || [])];
  const colorPalette = colorsPalettes ? allColorsPalette : settings === null || settings === void 0 ? void 0 : settings.colors;
  return {
